/*-------------------------------------------------------------
 ...
 Inizializza la scheda NodemCU come client che una volta agganciata ad un acces point, tramite hot spot del cellulare o altro, pubblica un apagina in html raggiungibile
 tramite indirizzo IP fisso. Non c'è bisogno di connessione ad internet, il sistema lavora sulla rete locale, tramite il l'utilizzo di WiFi.
 ------------------------------------------------------------------------------
 Licenza:
...
char* ssid = "metti la tua SSID";
char* password = "metti la tua PASSWORD";
...
{ 
  ...
  server.on("/antestate",getANTEState);
  server.begin();
